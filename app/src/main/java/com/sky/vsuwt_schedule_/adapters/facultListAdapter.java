...
public class facultListAdapter extends RecyclerView.Adapter<facultListAdapter.listViewHolder> {
    ...
    public facultListAdapter(Context mContext, ArrayList<listModel> models)
    {
    ...
    public void onBindViewHolder(@NonNull listViewHolder holder, int position){
        ...
        holder.setItemClickListener(new ItemClickListener(){
            ...
            public void onClick(View view, int position) {
                config.facultRowIndex = position;
        ...
        if (config.facultRowIndex == position){
