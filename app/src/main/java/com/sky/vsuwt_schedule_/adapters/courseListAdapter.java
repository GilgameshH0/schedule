...
public class courseListAdapter extends RecyclerView.Adapter<courseListAdapter.listViewHolder> {
    ...
    public courseListAdapter(Context mContext, ArrayList<listModel> models)
    {
    ...
    public void onBindViewHolder(@NonNull listViewHolder holder, int position){
        ...
        holder.setItemClickListener(new ItemClickListener(){
            ...
            public void onClick(View view, int position) {
                config.courseRowIndex = position;
        ...
        if (config.courseRowIndex == position){
